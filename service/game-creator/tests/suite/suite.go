...
func New() *Suite {
	...
	application := app.New(cfg.AppConfig, db, ssoClient, slog.New(prettylogger.NewDiscardHandler()))
	go application.Run()
	...
	suite := &Suite{App: application, Client: &httpClient, SSOClient: ssoClient, URL: url}
